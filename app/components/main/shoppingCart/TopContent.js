...
{
  /* 从右角开始 M:起始坐标(x y) / V: 垂直画一条直线到(y: 0) / A: x半径(75) y半径(75) / 椭圆弧的x-axis-rotation（x轴旋转角度）是0 / 弧长large-arc(0小弧即弧线小于180度) / 方向(1逆时针) 终点sweep(midX, midY) / H: 水平画一条直线到(midY) / A: x半径(75) y半径(75) / x轴旋转指示椭圆整体如何相对于当前坐标系旋转（以度为单位）(0) / 弧长(0小弧) / 方向(0顺时针) 终点sweep(0 y) / Z:关闭路径 */
}
